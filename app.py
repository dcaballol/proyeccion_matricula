...
def cargar_matricula():
    # Busca todos los ZIPs partido por nombre
    part_zips = sorted(glob.glob("Asistencia_2015-2025_part*.zip"))
    dfs = []

    if not part_zips:
        st.error("No se encontraron los archivos ZIP partidos. Verifica que existan en la carpeta del proyecto.")
        return pd.DataFrame()
    ...
    # Ajusta las columnas como antes
